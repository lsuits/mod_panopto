...
/**
 * Strings for component 'panopto', language 'en', branch 'MOODLE_20_STABLE'
 *
 * @package    mod_panopto
...
$string['createpanopto'] = 'Create a Panopto link on your course';
$string['displayoptions'] = 'Available display options';
$string['displayselect'] = 'Display';
$string['displayselect_help'] = 'This setting, and whether the browser allows embedding, determines how the Panopto is displayed. Options may include:

* Automatic - The best display option for the Panopto is selected automatically
* Embed - The Panopto is displayed within the page below the navigation bar together with the Panopto description and any blocks
* Open - Only the Panopto is displayed in the browser window
...
$string['printintro'] = 'Display Panopto description';
$string['printintroexplain'] = 'Display Panopto description below content? Some display types may not display description even if enabled.';
$string['authinstance'] = 'Authentication Instance';
$string['panoptoserver'] = 'Panopto Server';
$string['serverpanopto'] = 'Server Panopto';
$string['panopto:addinstance'] = 'Add a new Panopto resource';
$string['panopto:view'] = 'View Panopto';
